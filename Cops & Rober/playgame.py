...
def Gameplay(screen,latar):
        ...
        mixer.music.load("../Cops & Rober/sounds/mainplay2.mp3")
        mixer.music.play(-1)

        # Menginisiasi image untuk button
        play_img = pygame.image.load("../Cops & Rober/Assets/tombol/play.png").convert_alpha()
        pause_img = pygame.image.load("../Cops & Rober/Assets/tombol/pause.png").convert_alpha()
        surrend_img = pygame.image.load("../Cops & Rober/Assets/tombol/surrend.png").convert_alpha()
        ...
        # inisiasi player
        player_img = pygame.image.load("../Cops & Rober/Assets/objek/player.png").convert_alpha()
        x1 = 300
        y1 = 300
        ...
        money = '../Cops & Rober/Assets/objek/money.png'
        diamond = '../Cops & Rober/Assets/objek/diamond.png'
        treasure = '../Cops & Rober/Assets/objek/treasure.png'
        lock = '../Cops & Rober/Assets/objek/lock.png'
        handcuffs = '../Cops & Rober/Assets/objek/handcuffs.png'
        police = '../Cops & Rober/Assets/objek/police.png'

        ly = ['../Cops & Rober/Assets/objek/treasure.png',
              '../Cops & Rober/Assets/objek/money.png',
              '../Cops & Rober/Assets/objek/diamond.png',
              '../Cops & Rober/Assets/objek/lock.png',
              '../Cops & Rober/Assets/objek/handcuffs.png',
              '../Cops & Rober/Assets/objek/police.png']
        ...
        # spawn sumbu x
        lx = ['../Cops & Rober/Assets/objek/treasure.png',
              '../Cops & Rober/Assets/objek/money.png',
              '../Cops & Rober/Assets/objek/diamond.png',
              '../Cops & Rober/Assets/objek/lock.png',
              '../Cops & Rober/Assets/objek/handcuffs.png',
        ...
        while run:
                ...
                if surrend_button2.draw(screen):
                        mixer.music.load("../Cops & Rober/sounds/gameover.mp3")
                        mixer.music.play()
        ...
        # Pergerakan objek
                for i in range(num_of_objekA):
                        ...
                        if collision:
                                untung = mixer.Sound("../Cops & Rober/sounds/coin.mp3")
                                rugi = mixer.Sound("../Cops & Rober/sounds/hit2.mp3")
                                if ly3[i] == money:
                                        score_value += 100
                                        untung.play()
                                elif ly3[i] == diamond:
